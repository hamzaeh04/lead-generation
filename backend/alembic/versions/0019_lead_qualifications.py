"""lead_qualifications — AI-scored lead qualification runs

Append-only log of qualification runs against the need/capacity/timing/
reachability rubric (tiers A-E, override + disqualifier rules). A contact
can be re-scored over time; Contact.latest_qualification picks the most
recent row rather than this table being mutated in place.
