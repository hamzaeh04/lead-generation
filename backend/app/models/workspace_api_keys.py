...
class WorkspaceApiKeys(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    Mirrors the live provider keys: Apollo, Smartlead, Groq. Users create once
    and update in place — never more than one record per workspace.
    """
    ...
    groq_api_key: Mapped[str | None] = mapped_column(String(512), nullable=True)
